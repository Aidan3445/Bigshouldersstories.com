  ...
  return (
    <section
      ...
      <span className="grid grid-cols-2 gap-8 px-4">
        ...
        <p className="w-full body-white mb-4 text-sm md:text-base lg:text-lg xl:text-xl leading-snug justify-self-start max-w-72 min-[870px]:max-w-none min-[870px]:pr-38">
